...
public class P661_Image_Smoother {
    public int computeAverage(int[][] img, int row, int col) {
        ...
        for (int directionIdx = 0; directionIdx < directions.length; directionIdx++) {
            ...
            // System.out.println(String.format("Adding (%d, %d): Neighbour (%d, %d) - %d", row, col, neighbouringRow,
        ...
        totalCount ++;
        // System.out.println(String.format("Average (%d, %d): Sum (%d) | Count (%d) | Average (%d)", row, col, totalSum,
